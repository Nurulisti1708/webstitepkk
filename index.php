...
<?php } ?>								
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
      <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1" fdprocessedid="0n4ufk"></button>
        <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" aria-label="Slide 2" fdprocessedid="zntwik"></button>
        <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" aria-label="Slide 3" fdprocessedid="z7f33g"></button>
      </div>
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/ip4.gif" class="d-block w-100" width="1600" height="483" alt="...">
        ...
        <div class="carousel-item">
          <img src="img/ip5.jpg" class="d-block w-100" width="1600" height="483" alt="...">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img src="img/ip12.jpg" class="d-block w-100" width="1600" height="483" alt="...">
          <div class="carousel-caption d-none d-md-block">
      ...
      <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev" fdprocessedid="zd9uj9">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
      </button>
      <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next" fdprocessedid="o5jmbv">
    ...
    <div class="col-md-3 mb-3">
      ...
      <div class="thumbnail">
								...
								<a class="shop-item-image" href="shop-single-left.html">
									<img class="img-responsive" src="img/<?php echo $data[6] ?>" alt="shop first image" />
						...
						<li class="col-lg-2 col-sm-4">
							...
							<div class="shop-item">
								...
								<div class="thumbnail noborder nopadding">
									<!-- product image(s) -->
									<a class="shop-item-image" href="shop-single-left.html">
										<img class="img-responsive" src="img/<?php echo $data[7]?>" width="150" height="180" alt="" />
									</a>
									<!-- /product image(s) -->
									
									<!-- hover buttons -->
									<div class="shop-option-over">
										<a class="btn btn-default" href="shop-cart.php"><i class="fa fa-cart-plus size-18"></i></a>
									</div>
									<!-- /hover buttons -->
								...
								<div class="shop-item-summary text-center">
									<h2 class="size-14"><?php echo $data[2]?></h2>
